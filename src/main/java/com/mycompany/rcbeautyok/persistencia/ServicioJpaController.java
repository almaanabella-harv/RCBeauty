...
import com.mycompany.rcbeautyok.persistencia.exceptions.NonexistentEntityException;
...
public class ServicioJpaController implements Serializable {
    ...
    emf = Persistence.createEntityManagerFactory("RcBeautyPU");
    }
    ...
    public void edit(Servicio servicio) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            Integer id = servicio.getId_servicio();
